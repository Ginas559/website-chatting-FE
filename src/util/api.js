...
export const checkoutOrderApi = ({ shippingInfo, paymentMethod = 'COD', bankCode, selectedProductIds }) => {
    return axios.post('orders/checkout', { shippingInfo, paymentMethod, bankCode, selectedProductIds });
};
